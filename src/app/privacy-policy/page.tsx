...
export default function PrivacyPolicyPage() {
  useEffect(() => {
    ...
    jquery.src =
      "https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=685051eff25b20ed7a72c744";
    jquery.async = true;
    ...
    <>
      ...
      <div className="footer">
          ...
          <div className="column-13">
            <div className="title-style">
              <div className="logo-wrapper">
                <img src="/images/image-1.png" loading="lazy" width="86" height="77" alt="" className="image-1"/>
              </div>
            ...
            <div className="column-14">
              <div className="content-style-5">
                ...
                <div className="footer-links">
                  ...
                  <a className="link-2">Pricing</a>
                  <a className="link-3">Book Now</a>
                  <a className="link-4">Get a Quote</a>
                  <a className="link-5">Gallery</a>
                </div>
              </div>
            </div>
              ...
              <div className="content-style-6">
                ...
                <div className="footer-links">
                  <div className="frame-1">
                    <img src="/images/Background_3.svg" loading="lazy" width="19" height="19" alt="" />
                    <a href="https://www.facebook.com/share/16mRNrwCBz/?mibextid=wwXIfr" className="link-6">Facebook</a>
                  </div>

                  <div className="frame-1">
                    <img src="/images/Background_1.svg" loading="lazy" width="19" height="19" alt="" />
                    <a href="https://www.instagram.com/detailgeeksautospa" target="_blank" className="link-7">Instagram</a>
                  </div>

                  <div className="frame-1">
                    <img src="/images/Background.svg" loading="lazy" width="19" height="19" alt="" />
                    <a href="https://www.tiktok.com/@detailgeeksautospa" className="link-14">TikTok</a>
                  </div>

                  <div className="frame-1">
                    <img src="/images/Background_2.svg" loading="lazy" width="19" height="19" alt="" />
        ...
        <div className="credits">
          <img src="/images/Divider.svg" loading="lazy" width="1312" height="1" alt="" className="divider"/>
          <div className="row">
            <div className="link-style-2">© 2025 Detail Geeks Auto Spa. All rights reserved.</div>

            <div className="title-style">
              <div className="text-61">
                <a href="/privacy-policy" className="link-11 w--current">Privacy Policy</a>
              </div>
              <div className="text-61">
