    ...
    <div style={outer}>
      <div style={container}>
        <div style={card}>
          ...
          <div style={body}>
            <h1 style={h1}>Your invoice is ready</h1>
            <p style={lead}>
              Hi {firstName || "there"}
              {lastName ? ` ${lastName}` : ""}, your invoice is attached. Please
              keep it for your records.
            </p>

            <div style={detailList}>
              <div style={detailRow}>
                <div style={dt}>Booking</div>
                <div style={dd}>{reference || "—"}</div>
              </div>
              <div style={detailRow}>
                <div style={dt}>Total</div>
                <div style={dd}>{formatMoney(total)}</div>
              </div>
              <div style={detailRow}>
                <div style={dt}>Balance</div>
                <div style={dd}>{formatMoney(balance)}</div>
              </div>
            </div>
          </div>
        </div>
